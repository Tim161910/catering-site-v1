...
urlpatterns = [
    ...
    # STAFF PERSONAL
    path('dashboard/', views.StaffPersonalDashboardView.as_view(), name='my_dashboard'),
    ...
    # ADMIN / MANAGER
    path('staff/', views.StaffDashboardView.as_view(), name='staff_dashboard'), # Admin table with filters
    ...
    path('events/status/', views.EventStatusView.as_view(), name='event_status'),
    ...
    # interview accept/decline removed - now handled in my_dashboard POST
    ...
    # OTHER
    path('risk-dashboard/', views.RiskDashboardView.as_view(), name='risk_dashboard'),
